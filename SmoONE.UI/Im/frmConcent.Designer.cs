...
namespace SmoONE.UI.Im
{
    partial class frmConcent : Smobiler.Core.Controls.MobileForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.im1 = new Smobiler.Core.Controls.RongIM.IM();
            // 
            // title1
            // 
        ...
        "群组"};
            ...
            // 
            this.im1.Name = "im1";
            this.im1.LoadUserInfo += new Smobiler.Core.Controls.RongIM.IMLoadUserInfoHandler(this.im1_LoadUserInfo);
            this.im1.LoadGroupInfo += new Smobiler.Core.Controls.RongIM.IMLoadGroupInfoHandler(this.im1_LoadGroupInfo);
            this.im1.LoadGroupMembers += new Smobiler.Core.Controls.RongIM.IMLoadGroupMembersHandler(this.im1_LoadGroupMembers);
            this.im1.TokenExpired += new Smobiler.Core.Controls.RongIM.IMTokenExpiredHandler(this.im1_TokenExpired);
            // 
            // frmConcent
            // 
        ...
        public Smobiler.Core.Controls.RongIM.IM im1;
    }
}